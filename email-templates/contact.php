...
<?php
  if(isset($_POST['email'])){
	...
	$receiver="info@rommelfowler.com";
	...
	<tr>
	<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://www.yourdomain.com/assets/images/logo-email.png' ></td>
	</tr>
	<tr>
